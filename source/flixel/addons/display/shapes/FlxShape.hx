...
class FlxShape extends FlxSprite
{
	...
	// saves the first shape Width & Height, I know I can do something in FightState but I don't want to do it
	public var firstShapeWidth(default, set):Float;
	public var firstShapeHeight(default, set):Float;
			...
			TrueHeight:Float = 0)
	{
		...
		firstShapeWidth = TrueWidth;
		firstShapeHeight = TrueHeight;
	...
	inline function set_firstShapeWidth(f:Float):Float
	{
		firstShapeWidth = f;
		return firstShapeWidth;
	}

	inline function set_firstShapeHeight(f:Float):Float
	{
		firstShapeHeight = f;
		return firstShapeHeight;
	}
}